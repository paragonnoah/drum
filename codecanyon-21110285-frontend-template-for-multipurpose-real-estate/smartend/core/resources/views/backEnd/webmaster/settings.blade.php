            ...
            <div class="col-sm-7 col-lg-10 light lt">
                ...
                <div class="tab-content pos-rlt">
                    ...
                    <button type="submit" id="save-settings-btn"
                            class="btn btn-info m-a pull-right">{{ trans('backLang.update') }}</button>
                    ...
                    <div
                        ...
                        <div class="p-a-md col-md-12">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="home_banners_section_id" id="home_banners_section_id"
                                        ...
                                        @foreach ($WebmasterBanners as $WebmasterBanner)
                                            ...
                                            ?>
                                            <option
                                                value="{{ $WebmasterBanner->id  }}" {{ ($WebmasterBanner->id == $WebmasterSetting->home_banners_section_id) ? "selected='selected'":""  }}>{!! trans('backLang.'.$WebmasterBanner->name)   !!}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="home_text_banners_section_id" id="home_text_banners_section_id"
                                        ...
                                        @foreach ($WebmasterBanners as $WebmasterBanner)
                                            ...
                                            ?>
                                            <option
                                                value="{{ $WebmasterBanner->id  }}" {{ ($WebmasterBanner->id == $WebmasterSetting->home_text_banners_section_id) ? "selected='selected'":""  }}>{!! trans('backLang.'.$WebmasterBanner->name)   !!}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="side_banners_section_id" id="side_banners_section_id"
                                        ...
                                        @foreach ($WebmasterBanners as $WebmasterBanner)
                                            ...
                                            ?>
                                            <option
                                                value="{{ $WebmasterBanner->id  }}" {{ ($WebmasterBanner->id == $WebmasterSetting->side_banners_section_id) ? "selected='selected'":""  }}>{!! trans('backLang.'.$WebmasterBanner->name)   !!}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>{{ trans('backLang.topicsOrderInFront') }} : </label>
                                    <select name="front_topics_order" id="front_topics_order"
                                            class="form-control c-select">
                                        <option value="asc" {{ (env("FRONTEND_TOPICS_ORDER","asc") == "asc") ? "selected='selected'":""  }}>{!!  trans('backLang.topicsOrderInFrontAsc') !!}</option>
                                        <option value="desc" {{ (env("FRONTEND_TOPICS_ORDER","asc") == "desc") ? "selected='selected'":""  }}>{!!  trans('backLang.topicsOrderInFrontDesc') !!}</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="home_content1_section_id" id="home_content1_section_id"
                                        ...
                                        @foreach ($GeneralWebmasterSections as $Webmaster_Section)
                                            ...
                                            ?>
                                            <option
                                                value="{{ $Webmaster_Section->id  }}" {{ ($Webmaster_Section->id == $WebmasterSetting->home_content1_section_id) ? "selected='selected'":""  }}>{!! str_replace("backLang.","",trans('backLang.'.$Webmaster_Section->name))   !!}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="home_content2_section_id" id="home_content2_section_id"
                                        ...
                                        @foreach ($GeneralWebmasterSections as $Webmaster_Section)
                                            ...
                                            ?>
                                            <option
                                                value="{{ $Webmaster_Section->id  }}" {{ ($Webmaster_Section->id == $WebmasterSetting->home_content2_section_id) ? "selected='selected'":""  }}>{!! str_replace("backLang.","",trans('backLang.'.$Webmaster_Section->name))   !!}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="home_content3_section_id" id="home_content3_section_id"
                                        ...
                                        @foreach ($GeneralWebmasterSections as $Webmaster_Section)
                                            ...
                                            ?>
                                            <option
                                                value="{{ $Webmaster_Section->id  }}" {{ ($Webmaster_Section->id == $WebmasterSetting->home_content3_section_id) ? "selected='selected'":""  }}>{!! str_replace("backLang.","",trans('backLang.'.$Webmaster_Section->name))   !!}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="latest_news_section_id" id="latest_news_section_id"
                                        ...
                                        @foreach ($GeneralWebmasterSections as $Webmaster_Section)
                                            ...
                                            ?>
                                            <option
                                                value="{{ $Webmaster_Section->id  }}" {{ ($Webmaster_Section->id == $WebmasterSetting->latest_news_section_id) ? "selected='selected'":""  }}>{!! str_replace("backLang.","",trans('backLang.'.$Webmaster_Section->name))  !!}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group m-t">
                                ...
                                <div>
                                    <select name="languages_by_default" class="form-control c-select">
                                        <option
                                            value="ar" {{ ($WebmasterSetting->languages_by_default=="ar")?"selected='selected'":"" }}>{{ strip_tags(trans('backLang.arabicBox')) }}</option>
                                        <option
                                            value="en" {{ ($WebmasterSetting->languages_by_default=="en")?"selected='selected'":"" }}>{{ strip_tags(trans('backLang.englishBox')) }}</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="p-a-md col-md-12">
                            ...
                            <div class="row m-t-3">
                                ...
                                <div class="col-md-8" id="facebook_ids_div"
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-sm-2 form-control-label">{!!  trans('backLang.loginAppID') !!}</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-sm-2 form-control-label">{!!  trans('backLang.loginAppSecret') !!}</label>
                                        <div class="col-sm-10">
                            ...
                            <div class="row m-t-2">
                                ...
                                <div class="col-md-8" id="twitter_ids_div"
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-sm-2 form-control-label">{!!  trans('backLang.loginConsumerAppKey') !!}</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-sm-2 form-control-label">{!!  trans('backLang.loginConsumerAppSecret') !!}</label>
                                        <div class="col-sm-10">
                            ...
                            <div class="row m-t-2">
                                ...
                                <div class="col-md-8" id="google_ids_div"
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-sm-2 form-control-label">{!!  trans('backLang.loginClientID') !!}</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-sm-2 form-control-label">{!!  trans('backLang.loginClientSecret') !!}</label>
                                        <div class="col-sm-10">
                            ...
                            <div class="row m-t-2">
                                ...
                                <div class="col-md-8" id="bitbucket_ids_div"
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-sm-2 form-control-label">{!!  trans('backLang.loginKey') !!}</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-sm-2 form-control-label">{!!  trans('backLang.loginSecret') !!}</label>
                                        <div class="col-sm-10">
                    ...
                    <div class="tab-pane {{  ( Session::get('active_tab') == 'googleMapsTab') ? 'active' : '' }}"
                         id="tab-10">
                        <div class="p-a-md"><h5>{!!  trans('backLang.googleMaps') !!}</h5></div>


                        <div class="p-a-md col-md-12">
                            <div class="form-group">
                                <label>{{ trans('backLang.googleMapsStatus') }} : </label>
                                <div class="radio">
                                    <div>
                                        <label class="ui-check ui-check-md">
                            ...
                            <div
                                ...
                                <div class="form-group">
                                    <label>{!!  trans('backLang.googleMapsKey') !!}</label>
                                    {!! Form::text('google_maps_key',env("GOOGLE_MAPS_KEY",""), array('placeholder' => '','class' => 'form-control','id' => 'google_maps_key', 'dir'=>trans('backLang.ltr'))) !!}
                                </div>
