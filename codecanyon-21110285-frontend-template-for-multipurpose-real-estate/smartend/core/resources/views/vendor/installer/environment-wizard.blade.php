        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_name" id="app_name" value="{{ $_SERVER['HTTP_HOST']  }}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_name_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                    ...
                    <input type="url" name="app_url" id="app_url" value="{{ str_replace("/install/environment/wizard","",((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}")) }}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_url_placeholder') }}" />
