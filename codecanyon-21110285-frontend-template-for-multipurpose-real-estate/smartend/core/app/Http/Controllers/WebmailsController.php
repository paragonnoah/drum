...
class WebmailsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->btn_clicked != "draft") {
            ...
            return redirect()->action('WebmailsController@index')->with('doneMessage', trans('backLang.messageSentSuccessfully'));
        }

        return redirect()->action('WebmailsController@index')->with('doneMessage', trans('backLang.saveDone'));
    }
